...
`../../backend/damoov-user-management-skill/references/user-management-api.md` — "Update user" section.
...
| Callbacks arrive on iOS but not Android | Android RTLD integration not wired | Check Android RTLD callback setup in `../android-telematics-sdk-integration-skill/references/android/integration-reference.md` |
