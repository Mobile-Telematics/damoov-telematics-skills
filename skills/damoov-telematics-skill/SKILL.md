...
| React Native app, Expo app, `app.json` plugins / `expo prebuild`, TypeScript, `react-native-telematics`, native bridge, React Native Android/iOS host setup | [`react-native-telematics-sdk-integration-skill`](../mobile/react-native-telematics-sdk-integration-skill/SKILL.md) |
