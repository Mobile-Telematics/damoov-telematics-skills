...
5. Use this DeviceToken in your mobile SDK: `setDeviceID(deviceToken)` (see `../../shared/references/devicetoken-flow.md`).
...
**Required:** Read `../damoov-backend-registration-skill/references/hierarchy.md`
...
1. Call `setDeviceID(deviceToken)` in your platform's SDK (see `../../shared/references/devicetoken-flow.md`).
...
- `../damoov-backend-registration-skill/references/hierarchy.md` — Accounts API hierarchy resolution
